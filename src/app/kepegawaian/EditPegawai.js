    ...
    return (
      <ModalEdit modalId={id} nama={nama}>
        ...
        <div className="modal-action">
          {edit ? (
            <label htmlFor={id} className="btn btn-neutral btn-sm" onClick={editHendler}>
              Edit
            </label>
          ) : (
            <label className="btn btn-error btn-sm" onClick={simpanHendler}>simpan</label>
          
          )}
  
          <label htmlFor={id} className="btn btn-warning btn-sm" onClick={()=>{setEdit(true)}}>
            Tutup
          </label>
        </div>
      </ModalEdit>
